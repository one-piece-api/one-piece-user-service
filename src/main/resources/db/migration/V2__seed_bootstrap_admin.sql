...
-- invite flow exists to create application users the normal way. luffy's ADMIN role and
-- ACTIVE status are set on the realm/Keycloak account itself, not here — see V1 for why
-- roles and status are not stored in this table.

INSERT INTO application_user (user_id, email)
VALUES ('446fbe79-5cc4-458d-925d-9934334b6dcf', 'luffy@onepiece.local');
