package dev.onepieceapi.userservice.config.keycloak;
...
public class KeycloakAdminConfig {
	...
	/**
	 * Backs the independent Admin API calls in {@code KeycloakClient}: cheap,
	 * unbounded-by-design threads for blocking I/O (the admin client above is a
