...
/**
 * Raised when resending an invitation (UF-IDU-03) targets a user who is no longer
 * PENDING (§10) - already activated, or disabled. Resending only ever makes sense for an
 * account that still has no usable credential.
 */
