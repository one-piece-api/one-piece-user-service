...
public enum UserErrorCode implements ErrorCode {
	...
	LAST_ROLE, ROLE_ALREADY_EXISTS, ROLE_NOT_FOUND, ROLE_IN_USE, PERMISSION_ALREADY_EXISTS, PERMISSION_NOT_FOUND,
	LAST_ROLE_MANAGER, INVALID_ROLE_NAME, PERMISSION_IN_USE;
