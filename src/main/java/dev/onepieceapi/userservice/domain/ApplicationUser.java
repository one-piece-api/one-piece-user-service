 ...
 * identity-provider equivalent. Account status and email verification are deliberately not
 * carried here either, for the same reason as roles: Keycloak is the sole owner of that
 * data and authorization reads it from the token / the identity provider directly, rather
 * than a local copy that could drift out of sync (see
